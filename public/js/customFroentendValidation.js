...
function getSupplierServices(e = null) {
    "add" == e && $("#supplier_services_crud").html("");
    var r = $(".supplier_id").val();
    $.ajax({
        type: "get",
        ...
        success: function(r) {
            if (console.log("supplier_services_crud-data", r), r.length > 0)
                for (var s = "", a = "", i = "", t = "", n = 0; n < r.length; n++) {
                    ...
                    var o = '<tr id="supplier_services_crud_id_' + r[n].id + '"><td>' + r[n].service_name + "</td><td>" + r[n].event_name + "</td><td>" + r[n].business_name + "</td><td>" + r[n].price_range + "</td><td>" + r[n].location + '</td><td><a class="supplier_media_link" href=' + a + '  target="_blank">' + s + '</a></td><td><a class="supplier_media_link" href=' + i + '  target="_blank">' + t + "</a></td>";
