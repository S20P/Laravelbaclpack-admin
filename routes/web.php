...
//    Route::post('/contact_us_send', 'HomeController@sendContactUs')->name('ContactUs');
    ...
    Route::get('/supplier-tack-and-care', 'HomeController@supplierTakeAndCare')->name('SupplierTackandCare');
    ...
    Route::post('/social_login', 'Auth\SocialAccountController@registerandLogin')->name('sociallogins');
   ...
   //    Route::post('blog_search', 'HomeController@blogSearch')->name('blogSearch');
    // Admin :
